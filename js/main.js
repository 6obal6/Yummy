...
$(".nav-tab-menu li a").click(function (e) {
    ...
    if (listBy == "contact") {
        $(".loading-container").fadeIn(100)
        document.getElementById("refreshRes").innerHTML = `<section class="foods d-flex justify-content-around  w-75 mx-auto mb-1">
        <section class="contact container ">
            ...
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <div class="mb-4">
                        <input type="text" placeholder="Enter Phone " class="form-control bg-transparent text-white input-data" id="userPhone" onkeyup="validation()">
                        <div id="phoneAlert" class=" d-none mt-1 alert-danger alert" role="alert">Enter valid Phone Number</div>   
                    </div>
                    <div class="mb-4">
                        <input type="password" placeholder="Enter Password" class="form-control bg-transparent text-white input-data" id="userPassword" onkeyup="validation()">
                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        <input type="text" placeholder="Enter Email" class="form-control bg-transparent text-white input-data" id="userEmail" onkeyup="validation()">
                        <div id="userEmailAlert" class=" d-none alert-danger alert" role="alert">Enter valid email. *Ex: xxx@yyy.zzz</div>
                    </div>
                    <div class="mb-4">
                        <input type="text" placeholder="Enter Age" class="form-control bg-transparent text-white input-data" id="userAge" onkeyup="validation()">
                        <div id="ageAlert" class=" d-none alert-danger alert" role="alert">Enter valid Age</div>
                    </div>
                    <div class="mb-4">
                        <input type="password" placeholder="Enter RePassword" class="form-control bg-transparent text-white input-data" id="userRepassword" onkeyup="validation()">
